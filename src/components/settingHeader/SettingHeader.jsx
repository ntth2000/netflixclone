...
const SettingHeader = () => {
  ...
  useEffect(() => {
    $(document).ready(function () {
      $(".settingHeader > .right > .img-wrapper").hover(
        function () {
          $(".settingHeader > .right > .profile").addClass("active");
        },
        function () {
          $(".settingHeader > .right > .profile").removeClass("active");
        }
      );
      $(".settingHeader > .right > .profile").hover(
        function () {
